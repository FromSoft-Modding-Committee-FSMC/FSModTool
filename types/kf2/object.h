...
struct ObjectClass
{
    ...
    uint8_t unknown0x02;
    uint8_t unknown0x03;
    uint16_t collisionCylinderPrimaryRadius;
    uint16_t collisionCylinderSecondaryRadius;
    uint16_t collisionCylinderHeight;
    uint16_t unknown0x0a;
    uint8_t unknown0x0c;
    uint8_t unknown0x0d;
    uint8_t unknown0x0e;
    SoundID soundEffect0;
    uint8_t unknown0x10;
    uint8_t unknown0x11;
    uint8_t unknown0x12;
    uint8_t unknown0x13;
